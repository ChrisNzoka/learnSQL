...
-- notice here I have to use back ticks to specify the column names  - without them it doesn't work
...
-- notice here I don't have to use back ticks to specify the column name
